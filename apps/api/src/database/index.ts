...
import {
  ...
  orderItemTableRelations,
  orderTableRelations,
  productFavoriteTableRelations,
  productImageTableRelations,
  productRelatedTableRelations,
  productTableRelations,
  projectTableRelations,
  promotionProductTableRelations,
  promotionTableRelations,
  reviewTableRelations,
